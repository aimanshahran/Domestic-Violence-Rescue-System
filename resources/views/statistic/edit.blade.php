    ...
    <div class="col mx-auto">
        <div class="card card-2">
            <div class="container rounded bg-white mt-5 mb-5">
                <h2><a href="{{ route('statistic.show') }}" style="color: black"><i class="fa fa-arrow-left" aria-hidden="true"></i></a>&nbsp;Manage Statistic</h2>
                @if (session('success'))
                ...
                <table class="table table-borderless" style="width:100%;">
                    <tr>
                        <form action = "{{ route('statistic.update', $stat->id) }}" method="post">
                            ...
                            <td>
                                <input type="text" name="year" class="form-control @error('year') is-invalid @enderror" value="{{ old('year') ?? $stat->year }}">
                                @error('year')
                    ...
                    <tr>
                            ...
                            <td><input type="number" name="data" class="form-control @error('data') is-invalid @enderror" value="{{ old('data') ?? $stat->data }}">
                                @error('data')
                                <div class="alert alert-danger">
                                    {{ $message }}
                                </div>
